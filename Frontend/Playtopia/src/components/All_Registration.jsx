...
export const All_Registration = () => {
    const [users, setUsers] = useState([
        { name: "Amelia Anderson", email: "ameliaanderson@example.com", Activation: "Logged in", role: "Rockstar Legend", teams: ["Player 1", "Player 2", "Player 3", "Player 4"], event_names: ["BGMI", "PES"], enrolled_event: 2 },
        { name: "John Doe", email: "johndoe@example.com", Activation: "Logged in", role: "Dummy God", teams: ["Player 1", "Player 2", "Player 3"], event_names: ["BGMI", "CS"], enrolled_event: 2 },
        { name: "John Doe", email: "johndoe@example.com", Activation: "Logged in", role: "Mortals", teams: ["Player 1", "Player 2", "Player 3", "Player 4"], event_names: ["NFS", "PES"], enrolled_event: 1 },
        { name: "John Doe", email: "johndoe@example.com", Activation: "Logged in", role: "User Choice", teams: ["Player 1", "Player 2"], event_names: ["CS", "NFS"], enrolled_event: 1 },
        { name: "John Doe", email: "johndoe@example.com", Activation: "Logged in", role: "User Choice", teams: ["Player 1", "Player 2", "Player 3"], event_names: ["VALO", "PES"], enrolled_event: 2 },
    ]);
    ...
    return (
        <section className="container px-4 mx-auto heading mt-5">
            <h1 className="text-center heading text-5xl">Admin Panel</h1>
