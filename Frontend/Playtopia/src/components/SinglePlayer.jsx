...
export const SinglePlayer = () => {
    const [users, setUsers] = useState([
        { name: "Amelia Anderson", email: "ameliaanderson@example.com", Activation: "Logged in", role: "Rockstar Legend", event_names: "PES" },
        { name: "John Doe", email: "johndoe@example.com", Activation: "Logged in", role: "Dummy God", event_names: "PES" },
        { name: "John Doe", email: "johndoe@example.com", Activation: "Logged in", role: "Mortals", event_names: "PES" },
        { name: "John Doe", email: "johndoe@example.com", Activation: "Logged in", role: "User Choice", event_names: "PES" },
        { name: "John Doe", email: "johndoe@example.com", Activation: "Logged in", role: "User Choice", event_names: "PES" },
    ]);
    const [currentPage, setCurrentPage] = useState(1);
    const usersPerPage = 5;

    // Logic to calculate paginat
    ...
    return (
        <section className="container px-4 mt-24 mx-auto heading">
            <div className="flex mt-4 items-center gap-x-3">
                <h2 className="text-lg font-medium text-gray-800">Single Player Registration</h2>
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {currentUsers.map((user, index) => (
                                <tr key={index}>
                                    ...
                                    <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">{user.event_names}</td>
