        ...
        <div className="carousel w-full h-full bg-cover bg-center">
          ...
          <div id="item1" className="carousel-item w-full bg-[url('/EventBg/Desktop/bgImg1.jpg')] bg-cover bg-center flex justify-start items-center text-white">
            <div className="h-[350px] w-[700px] mx-[90px] ">
              <h1 className="text-9xl md:text-7xl m-0 font-[Valorant]">Valorant</h1>
              <p className="text-2xl md:text-xl my-6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa deserunt at, id itaque dolor dolores cumque consequatur, accusantium quibusdam sequi eaque, assumenda asperiores fugit sint adipisci hic necessitatibus. Nisi, eius.</p>
              <div className="w-full flex mt-12">
                <button className="h-full w-[190px] md:w-[150px] rounded-md text-center text-2xl md:text-xl">Register</button>
              </div>
            </div>
          </div>
