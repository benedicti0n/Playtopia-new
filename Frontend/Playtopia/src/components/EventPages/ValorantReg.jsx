    ...
    return (
        <section className="h-screen w-full bg-gray-800">
            <div className="flex justify-center h-full w-full">
                <div className="hidden bg-cover bg-top lg:block lg:w-2/5" style={{ backgroundImage: 'url("/bgMobile.png")' }}>
                </div>
                <div className="flex items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5">
                    <div className="w-full ">
                        <h1 className="text-3xl font-bold tracking-wider text-white capitalize text-center">
                            Register with Valorant
                        </h1>
                        <form className="grid grid-cols-2 gap-5 mt-8 md:grid-cols-2 lg:grid-cols-4">
                            <div>
                            ...
                            <div>
                                <label className="block mb-2 text-sm text-gray-600">Player 1 Name</label>
                                <input type="text" placeholder="" className="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-400 focus:ring-opacity-40" />
                            </div>
                            <div>
                                <label className="block mb-2 text-sm text-gray-600">Player 1 Riot ID</label>
                                <input type="text" placeholder="" className="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-400 focus:ring-opacity-40" />
                            </div>
                            <div>
                            ...
                            <div className="w-full grid grid-cols-none">
